...
PADDLEOCR_MASK_MERGE_IOU = 0.72         # gộp cue shell trùng mask trước OCR (0 = tắt); 0.72 ≈ ~700 OCR frame
...
PADDLEOCR_NOISE_MIN_DURATION_MS = 50    # pre+post filter; 50ms cứu cue ngắn, chấp nhận ~700 OCR frame
