...
export class WhiteboardIdeasService {
  ...
  async listHistory(
    ...
    const qb = this.repository.createQueryBuilder("h").where("h.user_id = :userId", { userId: userId.trim() });
    ...
    const [rows, total] = await qb.orderBy("h.created_at", "DESC").take(take).skip(skip).getManyAndCount();
  ...
  private buildPrompt(idea: string): string {
    return [
      ...
      "Create a comprehensive educational documentary.",
      "Do NOT summarize.",
      "Explain the topic thoroughly and logically.",
      "Generate as many Scenes as necessary.",
      "Each Scene focuses on ONE major idea.",

      "==================================================",
      "OUTPUT LANGUAGE",
      "==================================================",

      "ALL generated content MUST be written in natural American English.",
      ...
      "- Voice narration",
      "- Visual descriptions",
      "- Text appearing inside visuals",

      "Write in fluent, natural English suitable for an educational documentary YouTube channel.",
      ...
      "- explain the major viewpoints",
      "- distinguish facts from hypotheses",
      "- never present speculation as fact",

      "If evidence is uncertain, explicitly state that experts have not reached a consensus.",

      "==================================================",
      "NARRATION",
      "==================================================",

      "Use a professional documentary narration style.",

      "Explain concepts progressively and logically.",
      ...
      "Commentary is encouraged but must never alter factual meaning.",
      ...
      "A Scene represents ONE major topic.",

      "Each Scene MUST contain:",

      "- Minimum 5 Storyboards",
      "- Maximum 9 Storyboards",

      "If a topic becomes too large, start a new Scene.",

      "The total number of Scenes is unlimited.",

      "==================================================",
      "STORYBOARD RULES",
      "==================================================",

      "Each Storyboard represents ONE continuous narration synchronized with its visual elements.",

      "Each Storyboard MUST:",

      "- explain only ONE idea",
      "- contain no more than TWO sentences",
      "- naturally connect to the previous and next Storyboard",
      "- remain concise and easy to understand",

      "Whenever the narration introduces a new concept, start a new Storyboard.",

      "Prefer shorter Storyboards.",
      ...
      "Do NOT repeatedly introduce the same primary illustration unless required for a new explanation.",

      "Assume previously introduced visual elements remain visible throughout the Scene.",

      "Each new Storyboard should:",

      "- reuse existing visuals conceptually",
      "- introduce only NEW visual elements",
      "- expand or explain existing visuals",

      "Avoid repeatedly describing the same object, character, animal, building, map, Earth, or main illustration unless it significantly changes.",
      ...
      "Use concise English for all visual descriptions.",
      ...
      'Voice: "Diamonds are the hardest natural material found on Earth."',
      ...
      '- Text: "Exceptional Hardness".',
      '- Arrow: Pointing to "Hardest Natural Material".',
      "- Icon: Hammer striking the diamond.",
      "- Icon: Earth.",
      "- Highlight: Glowing outline around the diamond.",
      ...
      "Do not stop after answering the main question.",
      "Whenever appropriate, continue exploring closely related topics that help viewers gain a deeper and more complete understanding.",
      ...
      "Expand only when the additional information is directly relevant to the topic.",
      ...
      "Assume the audience has no prior knowledge of the topic.",
      ...
      '{"title":"Video Title","scenes":[{"title":"Scene Title","storyboards":[{"voice":"Narration","visuals":["Visual 1","Visual 2","Visual 3"]}]}]}',
    ].join("\n");
  }
